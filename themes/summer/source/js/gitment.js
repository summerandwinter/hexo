    ...
    (function (module, exports, __webpack_require__) {
        ...
        function renderComments(_ref2, instance) {
            ...
            comments.forEach(function (comment) {
                ...
                commentItem.innerHTML = '\n      <a class="gitment-comment-avatar" href="' + comment.user.html_url + '" target="_blank">\n        <img class="gitment-comment-avatar-img" src="' + comment.user.avatar_url + '"/>\n      </a>\n      <div class="gitment-comment-main">\n        <div class="gitment-comment-header">\n          <a class="gitment-comment-name" href="' + comment.user.html_url + '" target="_blank">\n            ' + comment.user.login + '\n          </a>\n     <span title="' + createDate + '" class="gitment-comment-time">' + getTimeShow(createDate) + '</span>\n          ' + (createDate.toString() !== updateDate.toString() ? '<span title="comment was edited at ' + updateDate + '" class="gitment-comment-edited"> \u2022 edited</span>' : '') + '\n          <div class="gitment-comment-like-btn">' + _icons.heart + ' ' + (comment.reactions.heart || '') + '</div>\n        </div>\n        <div class="gitment-comment-body gitment-markdown">' + comment.body_html + '</div>\n      </div>\n    ';
