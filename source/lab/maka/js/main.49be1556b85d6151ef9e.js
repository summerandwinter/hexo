            ...
            value: function() {
                ...
                if (t = this.isAppNormalMode() ? window.projectVersion.p_version: (new Date).getTime(), this.isTemplate()) {
                    if (this.isStoreTemplatePreview() || this.isRemoveDesignerAd()) e = "/api/storeTemplate/" + i + "?dataType=pdata&v=" + t;
                        ...
                        if (!this.isVersionedTemplatePreview()) return e = "/user/" + o + "/template/" + i + "/" + i + "_v" + t + ".json",
                ...
                return this.isAppNormalMode() ? (e = "/user/" + o + "/event/" + i + "/" + i + "_v" + t + ".json", "test" === n || "development" === n ? e = "http://maka-test.oss-cn-beijing.aliyuncs.com" + e: "production" === n && (e = "http://res.maka.im" + e)) : (e = "/api/event/" + i + "?dataType=all&ts=" + t, "test" === n ? e = "http://test.api.maka.im" + e: "production" === n && (e = "http://api.maka.im" + e)),
                e
            }
        },
        {
