define(function (require, exports, module) {
    ...
    var pushMoney = function () {
        ...
        $.extendGet(moduleCommon.httpURL + $('#PushCountMoney').val(), {}, 'json', function (data) {
            moduleCommon.loaded();
        ...
        startCountMoneyTimer = setInterval(function () {
            if (i > 0) {
                ...
                CountMoneyTimes.text('GO').css('opacity', 1).animate({'opacity': 0}, 1000, function () {
                    $.extendGet(moduleCommon.httpURL + $('#OpenCountMoney').val(), {'countId': countId}, 'json', function (data) {
                        if (data.ResultType != 1) {
                            moduleCommon.showInfo(data.Message);
                            return;
                        }
