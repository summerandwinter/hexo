...
function(e, t) {
	...
	function i() {
		if (!Ot.is("wechat") && !(pt[lt] && pt[lt][4] || "no" === (W("toolbar") || "").toLowerCase())) {
			...
			if (!e) {
				...
				e.id = Gt.slice(1),
				e.innerHTML = ['<div id="hw-bar" class="hw-bar">', "<header>", "<h4>\u706b\u821e\u6e38\u620f\uff0c\u4e3a\u672a\u6765\u800c\u751f</h4>", '<div class="hw-clip">', '<div class="hw-clip-btn"><img src="' + ht + '/images/home/logo200.png"></div>', "</div>", "</header>", "<nav>", "<ul>", Ot.env.app ? "": '<li><a href="#" class="hw-btn-app" data-action="app">\u5b89\u88c5<strong>\u706b\u821eAPP</strong>\uff0c\u4f53\u9a8c\u7cbe\u54c1\u6e38\u620f</a></li>', Ot.env.wechat ? '<li><a href="#" data-action="share">\u6311\u6218\u597d\u53cb</a></li>': "", '<li><a href="#" data-action="more">\u66f4\u591a\u6e38\u620f</a></li>', '<li><a href="#" class="hw-btn-resume" data-action="close">\u8fd4\u56de\u6e38\u620f</a></li>', "</ul>", "</nav>", "</div>"].join(" "),
	...
	function h() {
		...
		if (!e) {
			...
			e.innerHTML = Ht.channelLogo ? [Ht.channelAloneLogo ? '<div class="inner alone"><img src="' + ht + "/images/home/loading_" + lt + '.png"></div>': "", '<div class="inner"' + (6 > o || o > 20 ? ' style="background: #2c2a2a;"': "") + ">", '<img src="' + ht + '/images/home/logo_wr_220x100_black.png" height="80">', '<img src="' + ht + "/images/home/logo_" + lt + '.png" height="80">', t ? "<p>" + (pt[lt][3] ? "\u201c<strong>" + pt[lt][0] + "</strong>\u201d": "<strong>\u706b\u821e</strong> &bull; <strong>" + t + "</strong>") + " \u539f\u521b\u51fa\u54c1</p><p>\u6388\u6743" + (pt[lt][3] ? "<strong>\u706b\u821e</strong>": "\u201c<strong>" + pt[lt][0] + "</strong>\u201d") + (pt[lt][5] || "\u8054\u5408\u53d1\u5e03") + "</p><p>\u8f6c\u8f7d\u8bf7\u7ecf\u8fc7\u6388\u6743\uff0c\u4fb5\u6743\u5fc5\u7a76</p>": "<p>" + (pt[lt][3] ? "\u201c<strong>" + pt[lt][0] + "</strong>\u201d\u51fa\u54c1, \u6388\u6743<strong>\u706b\u821e</strong>" + (pt[lt][5] || "\u8054\u5408\u53d1\u5e03") : "<strong>\u706b\u821e</strong>\u51fa\u54c1, \u6388\u6743\u201c<strong>" + pt[lt][0] + "</strong>\u201d" + (pt[lt][5] || "\u8054\u5408\u53d1\u5e03")) + "</p>", '<p class="hw_info">\u6e38\u620f\u8f7d\u5165\u4e2d...</p>', '<div class="progress" style="display:none;"><div class="bar">0%</div></div>', "</div>"].join("") : ['<div class="inner"' + (6 > o || o > 20 ? ' style="background: #2c2a2a;"': "") + ">", '<img src="' + ht + '/images/home/logo_wr_220x100_black.png" height="80">', t ? "<p><strong>\u706b\u821e\u6e38\u620f</strong> &bull; <strong>" + t + "</strong> \u539f\u521b\u51fa\u54c1</p><p>\u8f6c\u8f7d\u8bf7\u7ecf\u8fc7\u6388\u6743\uff0c\u4fb5\u6743\u5fc5\u7a76</p>": "<p>\u706b\u821e\u6e38\u620f &bull; \u4e3a\u672a\u6765\u800c\u751f</p>", '<p class="hw_info">\u6e38\u620f\u8f7d\u5165\u4e2d...</p>', '<div class="progress" style="display:none;"><div class="bar">0%</div></div>', "</div>"].join(""),
			e.addEventListener(nt, R),
			e.addEventListener(it, R),
			A("body").appendChild(e)
		}
	...
	function(t) {
		...
		w = {
			...
			link: bt,
			query: "",
			title: b.title || Z.title || "\u706b\u821e\u6e38\u620f",
			desc: b.desc || Z.title || "\u706b\u821e\u6e38\u620f"
		};
